...
struct ChangeLocalizable {
    ...
    static var confirmIsEmpty = "confirmIsEmpty".localized()
    static var newPassLess8Character = "newPassLess8Character".localized()
    static var newPassIsEmpty = "newPassIsEmpty".localized()
    static var newAndConfirmPassDiffrent = "newAndConfirmPassDiffrent".localized()
    static var newPassword = "newPassword".localized()
